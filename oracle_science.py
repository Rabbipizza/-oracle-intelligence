...
def collect(query,max_results=300):
    ...
    for start in range(0,max_results,page):
        ...
        url="https://export.arxiv.org/api/query?"+params; last_url=url
    ...
    obj={"meta":{"family":"science","source":"arXiv","primary":True,"peer_reviewed":"unknown","query":query,"url":last_url,"fetched_at":stamp,"complete":len(papers)>=max_results},"data":papers}
